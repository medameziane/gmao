...
switch ($method){
  ...
  case "POST":
    ...
    $sql = "INSERT INTO equipement VALUES (NULL,'$equipe->name','$equipe->description',CURRENT_DATE, '$equipe->prix', '$equipe->marque', '$equipe->reference', '$equipe->piecedeRechange','$equipe->document','$equipe->imageData','$equipe->categorie_id','$equipe->service_id')";
